...
{
    public static class PersianIdentityErrorDescriberExtension
    {
        public static IdentityBuilder AddPersianIdentityErrorDescriber(this IdentityBuilder builder)
            => builder.AddErrorDescriber<PersianIdentityErrorDescriber>();
    }
    public class PersianIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        => new IdentityError
        {
            ...
            Description = "رمز عبور صحیح نمیباشد"
        };
